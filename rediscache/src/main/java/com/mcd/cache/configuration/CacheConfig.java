...
public class CacheConfig extends CachingConfigurerSupport {
    ...
    public JedisConnectionFactory redisConnectionFactory(CacheConfigurationProperties properties) {
        log.info("Redis (/Lettuce) configuration enabled. With cache timeout " + properties.getDefaultExpiration() + " seconds.");
    ...
    public RedisCacheConfiguration cacheConfiguration(CacheConfigurationProperties properties) {
        return createCacheConfiguration(properties.getDefaultExpiration());
    }
    @Primary
    @Bean(name = "manager")
